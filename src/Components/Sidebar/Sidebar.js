...
const allTools = [
    {
        title: 'JavaScript, HTML, CSS, SCSS',
    },
    {
    ...
    {
        title: 'CSS3, MUI, Tailwind CSS',
    },
    {
        title: 'MySQL, React Native',
    },
    {
        title: 'Git, NPM, Yarn, VS Code',
    },
    {
    ...
    return (
        <div className="sidebar">
            ...
            <div className="left_footer">
                ...
                <a href="https://github.com/anondobormon" target="_blank" rel="noreferrer">
                ...
                <a href="https://twitter.com/AnondoBormon1" target="_blank" rel="noreferrer">
